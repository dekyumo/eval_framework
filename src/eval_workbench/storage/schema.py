...
NODE_TABLES = {
    ...
    "EvalCase": "id STRING, name STRING, target_agent_path STRING, conversation STRING, session_state STRING, input_payload STRING, distribution_position STRING, problem_type STRING, split STRING, difficulty_prior STRING, source STRING, tags STRING, metrics STRING, fault_config STRING, tool_fault STRING, PRIMARY KEY (id)",
